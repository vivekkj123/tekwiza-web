  ...
  return (
    <div className="Sponsors mb-5 pt-5  pb-10 bg-black rounded-xl bg-opacity-30 lg:px-16 mx-3 lg:mx-20">
      ...
      {/* flex lg:flex-row flex-col flex-wrap */}
        ...
        <Link href={""}>
          <ExportedImage alt="" className="hover:bg-black p-2 hover:bg-opacity-40 rounded-xl h-20 m-4 w-auto" src={Dstyle} />
        </Link>
        <Link href={""}>
          <ExportedImage alt="" className="hover:bg-black p-2 hover:bg-opacity-40 rounded-xl h-20 m-4 w-auto" src={EverestJewellary} />
        </Link>
        <Link href={""}>
          <ExportedImage alt="" className="hover:bg-black p-2 hover:bg-opacity-40 rounded-xl h-20 m-4 w-auto" src={WoodenPerk} />
        </Link>
        <Link href={""}>
          <ExportedImage alt="" className="hover:bg-black p-2 hover:bg-opacity-40 rounded-xl h-14 m-4 w-auto" src={BillionBees} />
        </Link>
        <Link href={""}>
          <ExportedImage alt="" className="hover:bg-black p-2 hover:bg-opacity-40 rounded-xl h-20 m-4 w-auto" src={LeosGD} />
        </Link>
        <Link href={""}>
          <ExportedImage alt="" className="hover:bg-black p-2 hover:bg-opacity-40 rounded-xl h-20 m-4 w-auto" src={Konikkara} />
        </Link>
