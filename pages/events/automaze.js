    ...
    <>
      ...
      <div className="bg-black  overflow-hidden h-full">
        ...
        <div className="lg:flex-row flex-col flex text-white  items-center  justify-around">
          ...
          <div className="h-auto card border-2 mx-2 border-white py-2 font-display flex flex-col items-center  my-2 rounded-lg lg:w-48 w-40" data-aos="fade-right" data-aos-delay="100">
