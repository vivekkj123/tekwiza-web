    ...
    <>
      ...
      <div className="bg-black h-full">
        ...
        <div className="flex lg:flex-row flex-col text-white items-center  lg:justify-around">
          ...
          <div className="h-auto border-2 mx-4 border-white py-9 font-display flex flex-col items-center my-4 rounded-lg lg:w-48 w-40" data-aos="fade-right" data-aos-delay="150">
